...
|----------|---------|-------------|
| `PROJECT_NAME` | `Synervia` | Display name for the project |
...
| `POSTGRES_DB` | `synervia` | Database name |
...
| `LOGFIRE_SERVICE_NAME` | `synervia` | Service name in Logfire dashboard |
...
| `S3_RAG_BUCKET` | `synervia-rag` | Bucket name |
...
| `S3_BUCKET` | `synervia` | Bucket name |
