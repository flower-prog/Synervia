...
|----------|---------|-------------|
| `PROJECT_NAME` | `ai_agent_6` | Display name for the project |
...
| `POSTGRES_DB` | `ai_agent_6` | Database name |
...
| `LOGFIRE_SERVICE_NAME` | `ai_agent_6` | Service name in Logfire dashboard |
...
| `S3_RAG_BUCKET` | `ai_agent_6-rag` | Bucket name |
