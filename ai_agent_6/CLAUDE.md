...
**ai_agent_6** - FastAPI application generated with [Full-Stack AI Agent Template](https://github.com/vstorm-co/full-stack-ai-agent-template).
...
# RAG
uv run ai_agent_6 rag-collections
uv run ai_agent_6 rag-ingest /path/to/file.pdf --collection docs
uv run ai_agent_6 rag-search "query" --collection docs
uv run ai_agent_6 rag-sync-gdrive --collection docs
uv run ai_agent_6 rag-sync-s3 --collection docs

# Sync Sources
uv run ai_agent_6 cmd rag-sources
uv run ai_agent_6 cmd rag-source-add
uv run ai_agent_6 cmd rag-source-sync
```
